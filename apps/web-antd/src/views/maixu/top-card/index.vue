...
function buildQueryParams(page = paginationCurrent.value, pageSize = paginationPageSize.value): TopCardQueryParams {
...
<template>
  <Page title="置顶卡设置" description="按群ID查询置顶卡，忽略剩余次数为0的数据，支持筛选、增删改查、导出。">
    <Card class="mb-4">
